...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <form action="/shippingifno" method="post">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalCenterTitle">New Shipping Address </h5>
            ...
            <div class="modal-body">
                    @csrf
                    <input type="hidden" name="user_id" value="{{\Illuminate\Support\Facades\Auth::user()->id}}" required>
                ...
                <div class="col-md-12 form-group" >
                        <input type="text" class="form-control" name="line1" placeholder="Address Line" required>
                    </div>
                    <div class="col-md-12 form-group" >
                    ...
                    <div class="col-md-12 form-group" >
                        <input type="text" class="form-control" name="apartment_number" placeholder="Appartment Number">
                    </div>
